<template>
    <section id="home" class="grid place-items-center mt-20 md:mt-10 overflow-hidden">
        ...
        <div class="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-2 items-end gap-10 lg:gap-16 w-full px-0 lg:px-10">
            ...
            <div class="text-5xl md:text-6xl font-bold text-white w-full pb-20 order-2 lg:order-1">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <h2>BOOO</h2>
                    <img src="../assets/images/head1-img.png" alt="head-1 image">

                </div>

                <h2 class="text-4xl md:text-5xl">Trick Or Treat !!</h2>

                <p class="pt-5 text-lg font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores
                    voluptatem quibusdam magnam molestias vero iste vitae magni expedita dolor corrupti!</p>
        ...
        <div class="grid place-items-center gap-2 text-white font-medium pt-8">
            ...
            <svg width="50px" height="50px" viewBox="0 0 72.00 72.00" id="emoji" xmlns="http://www.w3.org/2000/svg"
                ...
                <g id="SVGRepo_iconCarrier">
                    ...
                    <g id="line">
                        <path fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"
                            stroke-miterlimit="10" stroke-width="0.8640000000000001"
                        ...
                        <line x1="41.3312" x2="36.1155" y1="60.0161" y2="65.2318" fill="none" stroke="#000000"
                            stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                            stroke-width="0.8640000000000001" />
                        <line x1="30.8574" x2="36.073" y1="60.0161" y2="65.2318" fill="none" stroke="#000000"
                            stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                            stroke-width="0.8640000000000001" />
                        <line x1="30.8574" x2="36.073" y1="11.892" y2="6.6763" fill="none" stroke="#000000"
                            stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                            stroke-width="0.8640000000000001" />
                        <line x1="41.3312" x2="36.1155" y1="11.892" y2="6.6763" fill="none" stroke="#000000"
                            stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
                            stroke-width="0.8640000000000001" />
                    </g>
                </g>
